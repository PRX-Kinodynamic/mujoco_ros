...
int main(int argc, char** argv)
{
  ...
  interface::get_param_and_check(n,  "/model_path", model_path);
  interface::get_param_and_check(n, node_name_prefix + "/visualize", visualize);
  interface::get_param_and_check(n, node_name_prefix + "/save_trajectory", save_trajectory);
  interface::get_param_and_check(n, node_name_prefix + "/publish_ground_truth_pose", publish_ground_truth_pose);
