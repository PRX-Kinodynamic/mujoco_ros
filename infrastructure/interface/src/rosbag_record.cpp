...
int main(int argc, char** argv)
{
  ...
  for (int i = 0; i < topics.size(); ++i)
  {
    ...
    registred |= ackermann_drive_stamped_queue.register_topic(topic_name, topic_type,
                                                              "ackermann_msgs::AckermannDriveStamped", subscribers, nh);
    ...
    registred |= traj_queue.register_topic(topic_name, topic_type, "ml4kp_bridge::TrajectoryStamped", subscribers, nh);
    registred |= plan_queue.register_topic(topic_name, topic_type, "ml4kp_bridge::PlanStamped", subscribers, nh);
