...
class MushrPlant:
  ...
  def SE2_expmap(self, xd):
    ...
    if (torch.abs(w) < 1e-10):
      ...
      v_ortho = self.R_PI_2 @ v; #// points towards rot center
  ...
  def xdot(self, xd0, ut, dt):
    ...
    norm2 = Vprev_pos * Vprev_pos; # SquaredNorm
...
def test():
  GT_traj = [ [0.0,     1.0,      0.00000, 1.57080, 0.00000, 0.00000, 0.00000],
