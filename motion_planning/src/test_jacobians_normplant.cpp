...
int main(int argc, char** argv)
{
  ...
  StructuredSysidRuntime runtime(model_path, params, poly, use_cuda, "float64", use_normalized_plant);
  
  // Test cases: various state and control values
  std::vector<std::pair<StateDot, Control>> test_cases = {
    {StateDot(0.5, 0.0, 0.0), Control(0.5, 0.0)},
