...
rosbag_file = "/Users/Gary/Downloads/SysId ROS Bags-selected/plan1_cam0.bag"
...
topics=["/mushr/plan_stepper/control"]
i=0
for topic, msg, t in bag.read_messages(topics=topics):
    m = f'{t.secs}.{t.nsecs} {i} PlanStepper {msg.point[1]} {msg.point[0]}'
    i += 1
    print(m)
